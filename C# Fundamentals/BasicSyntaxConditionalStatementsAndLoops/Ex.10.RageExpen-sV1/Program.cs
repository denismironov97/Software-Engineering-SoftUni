...
namespace Ex._10.RageExpen_sV1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int currentLostGame = 1; currentLostGame <= lostGamesCount; currentLostGame++)
            {
                ...
                if (currentLostGame % 2 == 0 && currentLostGame % 3 == 0) //currentLostGame % 6 == 0
                {
                    countForTrashedKeyboard += 1;
                }
                if (currentLostGame % 2 == 0 && currentLostGame % 3 == 0 && countForTrashedKeyboard % 2 == 0) //currentLostGame % 12 == 0
                {
