...
namespace Ex._04.PasswordValidator
{
    class Program
    {
        ...
        static void ValidatePassword(string text)
        {
            ...
            if (CheckIfContainsOnlyDigitsAndLetters(passwordLenght, text) == false) // <-from the initialized variable from ValidatePassMethod(string)
            {
